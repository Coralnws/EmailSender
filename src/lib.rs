...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting EmailSender processing");
    
    let mut processor = EmailSenderProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = EmailSenderProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = EmailSenderProcessor::new(false);
